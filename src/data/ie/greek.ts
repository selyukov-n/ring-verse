...
Ἑπτὰ οἱ Νᾶνοι Κύριοι οἳ πύργους οἰκοῦσι λιθίνους,
Ἑννέα οἱ Ἄνθρωποι οἱ Βροτοὶ οἳ μόρον ἔχουσιν,
Ἕνα ὁ Σκοταῖος Ἄναξ, ὁ ἡγεμονεύων διὰ Σκότους,
Ἐν τῇ γῇ τῆς Μόρδορ, ἔνθα ζῶσι Σκιαί.
Ἕνα, πάντας κυβερνάτω καὶ εὑρίσκετω, Ἕνα.
Ἕνα, πάντας ὁμοῦ συγκομιζέτω, σκοταίαις ἐπῳδαῖς, Ἕνα.
Ἐν τῇ γῇ τῆς Μόρδορ, ἔνθα ζῶσι Σκιαί.`
    }]
  },
});
...
Στη γη της Μόρντορ, που ζούνε Σκιές.`
  ...
  536: {
    input: "2.3.0",
    author: sources.lyricstranslate.makeAuthor("Smokey Meydan"),
    content: `Τρία δαχτυλίδια για τους αντιβασιλείς κάτω απ'τον ουρανό.
Επτά για τους νάνους-ηγεμόνες στους λίθινους χώρους τους.
Εννιά για τους μελλοθάνατους επίσημα θνητούς άνδρες.
Ένα για τον Σκοτεινό Κύριο στον σκοτεινό θρόνο του,
στη Γη του Μόρντορ, όπου κείνται οι Σκιές.
Ένα δαχτυλίδι τους πάντες να κυβερνήσει και να ανασύρει.
Ένα δαχτυλίδι τους πάντες να συνάξει και με το σκοτάδι να τους ζώσει,
στη Γη του Μορντόρ, όπου κείνται οι Σκιές.`
  },
});
