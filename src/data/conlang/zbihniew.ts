...
export const byZbihniew = make({ input: "0.8.0", author: "zbihniew" }, {
  181: {
    language: "c.var",
    content: `Dri ringen for elfenkingen unter skaj
...
Iden dla Tmovym Vladcav na jeho tmovym tronev.
V Zemav Mordorev kde Tëny lëžetom
Iden perstën by vladať vse, Iden by najdeť vse,
Iden by zebrať óne vse i v tmov zvëzať
V Zemav Mordorev kde Tëny lëžetom.`
  },
  207: {
    language: "c.bzd",
...
Na Mordortałć ździe cienie leżu.`
  ...
  222: {
    language: "c.dem",
    content: `Dre vinisez voor li Ella-kenas pa la iavena,
...
In le Tauta de Mordor qde lishkavahi Tselen.`
  ...
  223: {
    language: "c.bli",
    content: `Drei vinisez voor Ella-kainos pa la iavena,
